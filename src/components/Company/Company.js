...
const Company = () => {
    ...
    return (
        <div className='flex flex-col gap-10 bg-purple-50/80 p-14 rounded-lg'>
            <h1 className='text-[#1E1F4B] text-xl font-bold text-center'>Trusted by greatest companies</h1>
